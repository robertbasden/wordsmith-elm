...
var _user$project$Main$getPercentageTimeElapsed = F2(
	function (startTime, currentTime) {
		var timeElapsed = currentTime - startTime;
		var allowedTime = 15 * 1000;
		return A3(_elm_lang$core$Basics$clamp, 0, 100, (timeElapsed / allowedTime) * 100);
	});
var _user$project$Main$timer = F2(
	function (startTime, currentTime) {
		var percentageElapsed = A2(_user$project$Main$getPercentageTimeElapsed, startTime, currentTime);
		var rotation = (percentageElapsed / 100) * 360;
		var rotationString = A2(
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$cx('100px'),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$cy('100px'),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$r('90px'),
										_1: {ctor: '[]'}
									}
								}
							},
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$d('M100 100 L100 30'),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$transform(rotationString),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
...
var _user$project$Main$button = F4(
	function (t, btnType, d, c) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$disabled(d),
				_1: {
					ctor: '::',
...
var _user$project$Main$buttonSet = function (buttons) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('button-set '),
			_1: {ctor: '[]'}
		},
		buttons);
};
var _user$project$Main$pageText = function (t) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('page-text'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Main$pageTitle = function (title) {
	return A2(
...
var _user$project$Main$container = function (children) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Main$checkResult = function (game) {
	var proposedSolution = _elm_lang$core$String$concat(
		A2(
			_elm_lang$core$List$map,
			function (_p1) {
				var _p2 = _p1;
			...
			game.choosenLetters));
	return _elm_lang$core$Native_Utils.eq(game.solution, proposedSolution);
};
var _user$project$Main$words = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 'MAXIMIZED', _1: 'Make as large or great as possible.'},
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'JACKKNIFE', _1: 'Move one\'s body into a bent or doubled-up position.'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'FLAPJACKS', _1: 'Sweet dense cakes made from oats, golden syrup, and melted butter, served in rectangles.'},
			_1: {ctor: '[]'}
		}
	}
};
var _user$project$Main$getNewWord = function (seed) {
	var wordGenerator = _elm_community$random_extra$Random_List$choose(_user$project$Main$words);
	var _p3 = A2(_elm_lang$core$Random$step, wordGenerator, seed);
	var newWord = _p3._0._0;
	var newSeed = _p3._1;
	var _p4 = newWord;
	if (_p4.ctor === 'Just') {
		var _p6 = _p4._0._0;
		var letterGenerator = _elm_community$random_extra$Random_List$shuffle(
			A2(_elm_lang$core$String$split, '', _p6));
		var _p5 = A2(_elm_lang$core$Random$step, letterGenerator, newSeed);
		var letters = _p5._0;
		var newSeed2 = _p5._1;
		return {
			ctor: '_Tuple2',
		...
		return _elm_lang$core$Native_Utils.crashCase(
			...
			_p4)('There are no words to choose from...');
	}
};
var _user$project$Main$showHint = function (game) {
	return _elm_lang$core$Native_Utils.update(
		game,
		{showHint: true});
};
var _user$project$Main$chooseLetter = F2(
	function (choosenLetterId, game) {
		return _elm_lang$core$Native_Utils.update(
			game,
			{
				choosenLetters: A2(
					...
					A2(
						...
						function (_p8) {
							var _p9 = _p8;
							return _elm_lang$core$Native_Utils.eq(_p9._0, choosenLetterId);
						},
						game.letters)),
				letters: A2(
					_elm_lang$core$List$filter,
					function (_p10) {
						var _p11 = _p10;
						return !_elm_lang$core$Native_Utils.eq(_p11._0, choosenLetterId);
					},
					game.letters)
			});
	});
var _user$project$Main$clear = function (game) {
	return _elm_lang$core$Native_Utils.update(
		game,
		{
			choosenLetters: {ctor: '[]'},
			letters: A2(_elm_lang$core$Basics_ops['++'], game.letters, game.choosenLetters)
		});
};
var _user$project$Main$undo = function (game) {
	return _elm_lang$core$Native_Utils.update(
		game,
		{
			choosenLetters: _elm_lang$core$List$reverse(
				A2(
					_elm_lang$core$List$drop,
					1,
					_elm_lang$core$List$reverse(game.choosenLetters))),
			letters: A2(
				_elm_lang$core$Basics_ops['++'],
				game.letters,
				A2(
...
var _user$project$Main$Game = F6(
	function (a, b, c, d, e, f) {
		return {letters: a, solution: b, hint: c, choosenLetters: d, showHint: e, startTime: f};
	});
var _user$project$Main$newGame = F2(
	function (seed, time) {
		var _p12 = _user$project$Main$getNewWord(seed);
		var letters = _p12._0._0;
		var word = _p12._0._1;
		var hint = _p12._0._2;
		var newSeed = _p12._1;
		return {
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {screen: a, seed: b, currentTime: c};
	});
var _user$project$Main$Danger = {ctor: 'Danger'};
...
var _user$project$Main$ShowHint = {ctor: 'ShowHint'};
var _user$project$Main$ChooseLetter = function (a) {
	return {ctor: 'ChooseLetter', _0: a};
};
var _user$project$Main$letterBlock = F3(
	function (selectable, listOfUsedIds, _p13) {
		var _p14 = _p13;
		var _p15 = _p14._0;
		var isDisabled = selectable && A2(_elm_lang$core$List$member, _p15, listOfUsedIds);
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'letter no-select', _1: true},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'letter--disabled', _1: isDisabled},
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Main$ChooseLetter(_p15)),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$Main$letterBlocks = F3(
	function (selectable, letters, listOfUsedIds) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'letter-container', _1: true},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'letter-container--selectable', _1: selectable},
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
			...
			A2(
				_elm_lang$core$List$map,
				A2(_user$project$Main$letterBlock, selectable, listOfUsedIds),
				letters));
	});
var _user$project$Main$Clear = {ctor: 'Clear'};
var _user$project$Main$Undo = {ctor: 'Undo'};
var _user$project$Main$gameScreen = F2(
	function (game, currentTime) {
		var listOfUsedIds = A2(
			_elm_lang$core$List$map,
			function (_p16) {
				var _p17 = _p16;
				return _p17._0;
			...
			game.choosenLetters);
		var allLetters = A2(_elm_lang$core$Basics_ops['++'], game.letters, game.choosenLetters);
		var someLettersChoosen = _elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$List$length(game.choosenLetters),
			0) > 0;
		var canShowHint = !game.showHint;
		var canSubmit = _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$List$length(game.choosenLetters),
			9);
		var canClear = _elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$List$length(game.choosenLetters),
			0) > 0;
		var canUndo = _elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$List$length(game.choosenLetters),
			0) > 0;
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A2(_user$project$Main$timer, game.startTime, currentTime),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A3(
						_user$project$Main$letterBlocks,
						true,
						A2(
							...
							F2(
								function (_p19, _p18) {
									var _p20 = _p19;
									var _p21 = _p18;
									return A2(_elm_lang$core$Basics$compare, _p20._0, _p21._0);
								}),
							allLetters),
						listOfUsedIds),
					_1: {
						...
						_1: {
							ctor: '::',
							_0: someLettersChoosen ? A3(_user$project$Main$letterBlocks, false, game.choosenLetters, listOfUsedIds) : A2(
								_elm_lang$html$Html$div,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('instructions-container'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Click or type the letters above to solve the anagram before the time runs out!'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								...
								_1: {
									ctor: '::',
									_0: _user$project$Main$buttonSet(
										{
											ctor: '::',
											_0: A4(_user$project$Main$button, 'Undo', _user$project$Main$Normal, !canUndo, _user$project$Main$Undo),
											_1: {
												ctor: '::',
												_0: A4(_user$project$Main$button, 'Clear', _user$project$Main$Danger, !canClear, _user$project$Main$Clear),
												_1: {
													ctor: '::',
													_0: A4(_user$project$Main$button, 'Submit', _user$project$Main$Success, !canSubmit, _user$project$Main$Submit),
													_1: {
														ctor: '::',
														_0: A4(_user$project$Main$button, 'Show Hint', _user$project$Main$Normal, !canShowHint, _user$project$Main$ShowHint),
														_1: {ctor: '[]'}
													}
												}
											}
									...
									_1: {
										...
										_1: {
											...
											_0: game.showHint ? A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('hint-container'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html$text(game.hint),
														_1: {ctor: '[]'}
													}
												}) : A2(
												_elm_lang$html$Html$div,
...
var _user$project$Main$GameOverScreen = function (a) {
	return {ctor: 'GameOverScreen', _0: a};
};
var _user$project$Main$GameScreen = function (a) {
	return {ctor: 'GameScreen', _0: a};
};
var _user$project$Main$TitleScreen = {ctor: 'TitleScreen'};
var _user$project$Main$init = function (timestamp) {
	return {
		ctor: '_Tuple2',
		_0: A3(
			_user$project$Main$Model,
			_user$project$Main$TitleScreen,
			_elm_lang$core$Random$initialSeed(timestamp),
...
var _user$project$Main$GameMsgContainer = function (a) {
	return {ctor: 'GameMsgContainer', _0: a};
};
var _user$project$Main$GoToGameOver = function (a) {
	return {ctor: 'GoToGameOver', _0: a};
};
	...
	function (message, model) {
		...
		while (true) {
			...
			switch (_p22.ctor) {
				case 'GoToTitle':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{screen: _user$project$Main$TitleScreen}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'StartNewGame':
					var _p23 = A2(_user$project$Main$newGame, model.seed, model.currentTime);
					var gameModel = _p23._0;
					var seed = _p23._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								screen: _user$project$Main$GameScreen(gameModel),
								seed: seed
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'NewWord':
					var _p24 = A2(_user$project$Main$newGame, model.seed, model.currentTime);
					var gameModel = _p24._0;
					var seed = _p24._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
				...
				case 'GoToGameOver':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								screen: _user$project$Main$GameOverScreen(_p22._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'Tick':
					var _p26 = _p22._0;
					var _p25 = model.screen;
					if (_p25.ctor === 'GameScreen') {
						var percentageElapsed = A2(_user$project$Main$getPercentageTimeElapsed, _p25._0.startTime, _p26);
						if (_elm_lang$core$Native_Utils.eq(percentageElapsed, 100)) {
							var _v11 = _user$project$Main$GoToGameOver('Whoops! You ran out of time!'),
				...
				case 'KeyUp':
					var _p33 = _p22._0;
					var _p27 = model.screen;
					if (_p27.ctor === 'GameScreen') {
						if (_elm_lang$core$Native_Utils.eq(_p33, _ohanhi$keyboard_extra$Keyboard_Extra$BackSpace)) {
							var _v14 = _user$project$Main$GameMsgContainer(_user$project$Main$Undo),
								_v15 = model;
							message = _v14;
							model = _v15;
							continue update;
						} else {
							var letter = _elm_lang$core$String$toUpper(
								_elm_lang$core$String$fromChar(
									_elm_lang$core$Char$fromCode(
										_ohanhi$keyboard_extra$Keyboard_Extra$toCode(_p33))));
							var choosenLetter = _elm_lang$core$List$head(
								A2(
									_elm_lang$core$List$map,
									function (_p28) {
										var _p29 = _p28;
									...
									A2(
										...
										function (_p30) {
											var _p31 = _p30;
											return _elm_lang$core$Native_Utils.eq(_p31._1, letter);
										},
										_p27._0.letters)));
							var _p32 = choosenLetter;
							if (_p32.ctor === 'Just') {
								var _v19 = _user$project$Main$GameMsgContainer(
									_user$project$Main$ChooseLetter(_p32._0)),
									_v20 = model;
								message = _v19;
								model = _v20;
								continue update;
				...
				default:
					var _p34 = model.screen;
					if (_p34.ctor === 'GameScreen') {
						var _p37 = _p34._0;
						var _p35 = _p22._0;
						switch (_p35.ctor) {
							case 'Undo':
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{
											screen: _user$project$Main$GameScreen(
												_user$project$Main$undo(_p37))
										}),
									_1: _elm_lang$core$Platform_Cmd$none
								};
							case 'Clear':
							...
							case 'ChooseLetter':
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										...
										{
											screen: _user$project$Main$GameScreen(
												A2(_user$project$Main$chooseLetter, _p35._0, _p37))
										}),
									_1: _elm_lang$core$Platform_Cmd$none
								};
							case 'ShowHint':
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										...
										{
											screen: _user$project$Main$GameScreen(
												_user$project$Main$showHint(_p37))
										}),
									_1: _elm_lang$core$Platform_Cmd$none
								};
							case 'Submit':
								if (_user$project$Main$checkResult(_p37)) {
									var _p36 = A2(_user$project$Main$newGame, model.seed, model.currentTime);
									var gameModel = _p36._0;
									var seed = _p36._1;
									return {
										ctor: '_Tuple2',
										_0: _elm_lang$core$Native_Utils.update(
									...
									var _v23 = _user$project$Main$GoToGameOver('Whoops! That was the wrong word!'),
										_v24 = model;
									message = _v23;
									model = _v24;
									continue update;
...
var _user$project$Main$NewWord = {ctor: 'NewWord'};
var _user$project$Main$StartNewGame = {ctor: 'StartNewGame'};
var _user$project$Main$titleScreen = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: _user$project$Main$pageTitle('WORDSMITH'),
		_1: {
			ctor: '::',
			_0: _user$project$Main$pageText('Complete the anagram before the time runs out'),
			_1: {
				ctor: '::',
				_0: _user$project$Main$buttonSet(
					{
						ctor: '::',
						_0: A4(_user$project$Main$button, 'Start Game', _user$project$Main$Success, false, _user$project$Main$StartNewGame),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Main$gameOverScreen = function (message) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Main$pageTitle('WHOOPS!'),
			_1: {
				ctor: '::',
				_0: _user$project$Main$pageText(message),
				_1: {
					ctor: '::',
					_0: _user$project$Main$buttonSet(
						{
							ctor: '::',
							_0: A4(_user$project$Main$button, 'Start Again?', _user$project$Main$Success, false, _user$project$Main$StartNewGame),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Main$view = function (model) {
	return _user$project$Main$container(
		{
			ctor: '::',
			_0: function () {
				var _p38 = model.screen;
				switch (_p38.ctor) {
					case 'TitleScreen':
						return _user$project$Main$titleScreen;
					case 'GameScreen':
						return A2(
							_elm_lang$html$Html$map,
							function (msg) {
								return _user$project$Main$GameMsgContainer(msg);
							},
							A2(_user$project$Main$gameScreen, _p38._0, model.currentTime));
					default:
						return _user$project$Main$gameOverScreen(_p38._0);
				}
			}(),
			_1: {ctor: '[]'}
		});
			...
			return _elm_lang$core$Platform_Sub$batch(
				{
					...
					_0: _elm_lang$animation_frame$AnimationFrame$times(
						function (time) {
							return _user$project$Main$Tick(time);
						}),
					_1: {
						ctor: '::',
						_0: _ohanhi$keyboard_extra$Keyboard_Extra$ups(_user$project$Main$KeyUp),
						_1: {ctor: '[]'}
					}
				});
		}
	})(_elm_lang$core$Json_Decode$int);
var _user$project$Main$GoToTitle = {ctor: 'GoToTitle'};
